...
import won.bot.paypal.framework.eventbot.action.impl.paypalbot.MyPaypalEventBotListenerAction;
import won.bot.paypal.framework.eventbot.action.impl.paypalbot.PaypalEchoMessagesAction;
 ...
 */
public class PaypalBot extends EventBot {
    ...
    protected void initializeEventListeners() {
        ...
        // Uncomment:
        // Do net get a Chat request after a need is created
        ...
        // Uncomment:
        // Do not open a hint on Need Create
...
//        bus.subscribe(NeedCreatedEventForDebugHint.class, this.needHinter);
        ...
        //Uncomment to get the first response of the bot
        ...
        // Importent Part for receiving Commands !!! ==============================================
        ...
        // Uncomment to use the DebugBotIncomingMessageToEventMappingAction
        ...
        //Action of PayPalEchoDebugCommandEvent
        bus.subscribe(PayPalEchoCommandEvent.class, new ActionOnEventListener(ctx, 
        		new PaypalEchoMessagesAction(ctx)));
        // End of MyPayPalEventBotListenerAction Integration ======================================
